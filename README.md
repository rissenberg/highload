...
![image](https://github.com/rissenberg/highload/assets/114286666/8bffdd25-339a-4184-91d5-b7c3e4101b3e)
...
В исследовании [[5](https://www.nginx.com/blog/testing-the-performance-of-nginx-and-nginx-plus-web-servers/)] nginx сказано, что сервер с 16 CPU видерживает 77 427 HTTP RPS
...
------------------------------------| ------ |----------|-----|-----|
Auth			            | 880	|  880 кб    | 8	| 1 	|
Feed	 	    	            | 11 920	|  53 Мб     | 120	| 12	|
Blog			            | 2 980	|  13,5 Мб   | 30	| 3	|
Post	                            | 117 025	|  118,4 Мб  | 1170	| 118	|
Media	                            | 117 025	|  40 Гб     | 1170	| 118	|
...
Feed  | 16 core CPU; 1х4 GB RAM 2400 MHz DDR4 | 8 |
Blog  | 4 core CPU; 1х4 GB RAM 2400 MHz DDR4 | 8 |
Post  | 16 core CPU; 1х8 GB RAM 2400 MHz DDR4 | 73 |
Media  | 16 core CPU; 1х8 GB RAM 2400 MHz DDR4 | 73 |
...
PostgreSQL способен выдавать около 350 000 TPS на 4 серверах на простых запросах, чего хватает для наших задач.

Необходимо сделать реплики. Тогда количество серверов будет равно 20 (4 master + 16 slave).
...
Сложная логика: posts, comments. Тогда необходимо покрыть 30 000 RPS

Простая логика: post_likes, post_views, attachments. Тогда необходимо покрыть 57 000 RPS

Для Posts+Comments необходим кластер из 3 серверов (master) + 6 (slave) + 9 (реплика)
Для Messenger необходим кластер из 2 серверов(master) + 4 (slave) + 6 (реплика)
