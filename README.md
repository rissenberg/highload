...
| API Gateway       |                     Шлюз API                          | 	Централизованная точка входа для всех API-запросов, упрощающая управление трафиком, мониторинг и масштабирование. 		  |
...
|  Сервис 	|  Назначение 	|
|---------------|---------------|
|  API GW	|  Централизированная точка входа запросов, перенаправление запроса в нужный сервис	|
...
Feed	 	    	            | 11 920	|  53 Мб
Blog			            | 2 980	|  13,5 Мб
Post	                            | 117 020	|  118,4 Мб
Media	                            | 117 020	|  40.5 Гб
 |  |
API GW			            | 132 830	|  186.4 Мб
Суммарный                           | 249 850	|  40.5 Гб

В исследовании [[5](https://www.nginx.com/blog/testing-the-performance-of-nginx-and-nginx-plus-web-servers/)] nginx сказано, что сервер с 24 CPU выдерживает 10,274 HTTPS CPS

**249 850 / 10 274 = 24.3** С округлением до целого вверх получаем 25 сервера.
...
------------------------------------| ------ |----------|-----|-----|
API GW			            | 132 800	|  186.4 Мб    | 2656	|  265	|
...
------ |---------- |--- |
Nginx  | 24 core CPU; 4x8 GB RAM 2400 MHz DDR4 | 25 |
API GW   | 24 core CPU; 1х4 GB RAM 2400 MHz DDR4 | 110 |
...
------ |------|----|-----|-----|------------|
Nginx  | Proxy   | 24  | 16  | 0,5 | 25 |
API GW | Service | 24  | 4   | 0,5 | 110   |
