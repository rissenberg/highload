...
## Содержание
  ...
  #### [9. Технологии](#tech)
  #### [10. Обеспечение надежности](#qa)
  #### [11. Схема проекта](#scheme)
  #### [12. Источники](#source)
...
<a name="qa"></a>
## 10. Обеспечение надёжности. <a name="9"></a>
...
| Асинхронные паттерны | Асинхронное выполнение операций удаления из облачного хранилища (такого как S3) для предотвращения задержек и повышения параллелизма. | 
